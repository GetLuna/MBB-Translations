...
'Quick search show_new'				=>	'Të reja',
'Quick search show_recent'			=>	'Aktive',
'Quick search show_unanswered'		=>	'Pa përgjigjie',
'Quick search show_replies'			=>	'Postuar',
'Quick search show_user_topics'		=>	'Tema nga %s',
'Quick search show_user_posts'		=>	'Postuar nga %s',
'Quick search show_subscriptions'	=>	'Abonuar nga %s',
'By keywords show as topics'		=>	'Temat që kan përmbajtje të postimeve \'%s\'',
'By keywords show as posts'			=>	'Postimet që përmbajnë \'%s\'',
'By user show as topics'			=>	'Temat që u postuan nga %s',
'By user show as posts'				=>	'Postimet nga %s',
'By both show as topics'			=>	'Topics with posts containing \'%s\', by %s',
'By both show as posts'				=>	'Postimet që përmbajnë \'%s\', by %s',
'No terms'							=>	'Ju duhët shtypni të pakten nji shkronje ose nji autor për të kërkuar.',
'No hits'							=>	'Kërkimi u kthye pa rezultat.',
'No user posts'						=>	'Nuk ka ndonje postim nga ky përdorues në këtë forum.',
'No user topics'					=>	'Nuk ka ndonje temë nga ky përdorues në këtë forum.',
'No subscriptions'					=>	'Ky përdorues nuk është aktualisht i abonuar në ndonje temë.',
'No new posts'						=>	'Nuk ka ndonje postim të ri që nga vizita juaj e fundit.',
'No recent posts'					=>	'Asnjë postim i ri për keto 24 orë.',
'No unanswered'						=>	'Nuk ka ndonjē postim pa përgjegjie në këtë forum.',
'Go to post'						=>	'Shko tek posti',
'Go to topic'						=>	'Shko tek tema',
...
'User is admin message'		=>	'Ky përdorues është %s nji administrator dhe nuk mund të përjashtohet. Nese deshironi ta largoni administratorin së pari duhêt ta shkarkoni nga detyra.',
'User is mod message'		=>	'Ky përdorues është %s nji moderator dhe nuk mund të përjashtohet. Nese deshironi ta largoni moderatorin së pari shkarkojeni nga detyra.',
'Must enter message'		=>	'Ju duhet të shkruani nji përdorues se paku, nji IP adres ose nji email (së paku).',
'Cannot ban guest message'	=>	'Mysafiret s\'mund të përjashtohen.',
'Invalid IP message'		=>	'Ju keni shtypur nji IP/IP-range të gabuar.',
'Invalid e-mail message'	=>	'Email adresa duhët të jetê (p.sh. user@domain.com) ose nji email parciale (p.sh. domain.com) e keni shtypur gabim.',
'Invalid date message'		=>	'Ju keni shtypur nji datë jovalide për skadim.',
'Invalid date reasons'		=>	'Formati duhët të jetë YYYY-MM-DD dhe data duhët të jetë së paku nji ditë e së ardhmes.',

'New ban head'				=>	'Shto të përjashtuar',
'Username help'				=>	'Përdoruesi për tu përjashtuar',
'Username advanced help'	=>	'Përdoruesi që deshironi ta përjashtoni. nese deshironi të përjashtoni nje IP-i specifike lereni të zbrazët rubriken.',

'Ban search head'			=>	'Kërko përjashtimet',
'Ban search info'			=>	'Kërko për përjashtime ne databazë. Ju mund të shtypni me shume terme për të kërkuar. Apo karaktere si (*) janë të lejueshme. Për tu shfaqur të gjitha përjashtimet leri fushat të pa plotesuara.',
'Date help'					=>	'(yyyy-mm-dd)',
'Expire after label'		=>	'Skadon pas',
'Expire before label'		=>	'Skadon përpara',
'Order by label'			=>	'Radhitja sipas',
'Order by ip'				=>	'IP',
'Order by expire'			=>	'Data e skadimit',
'Submit search'				=>	'Kërko',

'E-mail help'				=>	'Emaili apo domain emaili që deshironi ta përjashtoni',
'IP label'					=>	'IP adresa/IP-ranges',
'IP help'					=>	'IP-ja që dëshironi ta përjashtoni, ndajë adresat me hapësirë',
'IP help link'				=>	'Kliko %s për të parë statistikat për këtë përdorues.',
'Ban advanced head'			=>	'Kërkimi i avancuar për përjashtime',
'Ban advanced subhead'		=>	'Mbulo përjashtimet me nji email apo IP',
'Ban message label'			=>	'Mesazhi i përjashtimit',
'Ban message help'			=>	'Mesazhi për antarët e përjashtuar',
'Message expiry subhead'	=>	'Mesazhi i përjashtimit dhe skadimi',
'Expire date label'			=>	'Data e skadimit',
'Expire date help'			=>	'Kur skadon data e përjashtimit, e zbrazët për manuale',

'Results head'				=>	'Rezultatet e kërkimit',
'Results IP address head'	=>	'IP/IP-ranges',
'Results expire head'		=>	'Skadon',
'Results banned by head'	=>	'Përjashtuar nga',
'No match'					=>	'S\'ka shenja',
